...
# Project Variables
stateSubmitted = Gauge(
    "state_submitted", "Current count of batch jobs in submitted state"
)
...
stateSucceeded = Gauge(
    "state_succeeded", "Current count of batch jobs in succeeded state"
)
